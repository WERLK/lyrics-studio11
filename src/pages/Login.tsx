...
import { Mail, Lock, Eye, EyeOff, LogIn, AlertCircle, Github } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">欢迎回来</h1>
          <p className="text-sm sm:text-base text-purple-200/70">登录您的账户，继续创作</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          ...
          <div className="flex items-center justify-between text-xs sm:text-sm">
            <label className="flex items-center gap-2 text-purple-200/70 cursor-pointer">
              <input type="checkbox" className="rounded border-white/20 bg-white/5 text-purple-500 focus:ring-purple-500/50" />
              <span>记住我</span>
            </label>
